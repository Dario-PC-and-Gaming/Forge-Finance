...
export function createInvoiceMetadata(formData: Record<string, unknown>, businessAddress: string): InvoiceMetadata {
  return {
    ...
    attributes: [
      { trait_type: "Invoice Number", value: formData.invoiceNumber as string },
      { trait_type: "Customer Name", value: formData.customerName as string },
      { trait_type: "Customer Email", value: formData.customerEmail as string },
      { trait_type: "Services", value: formData.services as string },
      { trait_type: "Invoice Value", value: `${formData.invoiceValue as string} USD` },
      { trait_type: "Loan Amount", value: `${formData.loanAmount as string} USD` },
      { trait_type: "Due Date", value: formData.dueDate as string },
